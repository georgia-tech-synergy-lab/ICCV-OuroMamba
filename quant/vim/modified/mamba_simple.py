...
class Mamba(nn.Module):
    def __init__(
        ...
        self.act_func  = Q.Act()
        self.act_funcA = Q.Act()
        self.act_funcB = Q.Act()
        self.act_funcC = Q.Act()
        self.act_funcD = Q.Act()
        self.act_funcd = Q.Act_d() # Q.Act() for symmetric quantization
        ...
        if self.use_fast_path and inference_params is None:  # Doesn't support outputting the states
            if self.bimamba_type == "v1":
                ...
                out = mamba_inner_fn_no_out_proj(
                    ...
                    delta_softplus=True,
                    Q_Act = self.act_func,
                    Q_ActA = self.act_funcA,
                    Q_ActB = self.act_funcB,
                    Q_ActC = self.act_funcC,
                    Q_ActD = self.act_funcD,
                    Q_Actd = self.act_funcd,
